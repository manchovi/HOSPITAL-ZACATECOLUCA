...
$query_temp="SELECT temperatura, luz1, luz3, luz5, luz7, fecha from sensores ORDER BY id_sensor DESC LIMIT 0,1";
$result = mysqli_query($connection, $query_temp);

$query_hum="SELECT humedad, luz2, luz4, luz6, luz8, hora from sensores ORDER BY id_sensor DESC LIMIT 0,1";
$result1 = mysqli_query($connection, $query_hum);

//$query_luzpar1="SELECT luz1, luz2 from sensores ORDER BY id_sensor DESC LIMIT 0,1";
//$result2 = mysqli_query($connection, $query_luzpar1);
...
// if(!$result = mysqli_query($connection, $query)) die(); //si la conexi贸n cancelar programa
...
//     echo json_encode($rawdata);
    ...
    /*PUEDE SER ASI LA SOLUCI脫N CREANDO NUESTRO PROPIO FORMATO JSON*/
