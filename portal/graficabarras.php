	...
	<section class="full-box dashboard-contentPage">
		...
		<div class="container-fluid">
			<div class="page-header">
			  <h1 class="text-titles"><i class="zmdi zmdi-timer zmdi-hc-fw"></i>Gráfica de Barras<small> -->Temperatura y Humedad Relativa. <a href="graficabarras.php" type="button" class="btn btn-success"><span class = "glyphicon glyphicon-refresh"><span></a></small></h1>
			</div>
		</div>
				...
				<div class="col-xs-12" > 
					...
					<script>
						...
						options: {
							...
							tooltips:{mode: 'index'},
							legend:{display: true, position: 'bottom', labels: {fontColor: 'rgb(0,0,255)', fontSize: 16}}
						}
					});
					</script>
				</div>
