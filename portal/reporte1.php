		...
		<div class="container-fluid">
			<div class="row">
				<div class="col-xs-12">
						...
						<form class="form-inline" method="POST" action="./dompdf/print.php"  target="_blank">
						<div class="row"></div>
						<div class="row"></div>
						<div class="row">
							...
							<table class="table table-responsive text-center" >
								<tr>
									...
									<td><input type="date" class="form-control" placeholder="Date Start"  name="date1" required/></td>
									<td><label style="color: #000; font-size: 22px;">Hasta</label></td>
									<td><input type="date" class="form-control" placeholder="Date End"  name="date2" required/></td>
